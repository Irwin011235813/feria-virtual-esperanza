import{_ as _e,C as ge,r as z,S as me,F as Re,e as L,b as be,c as we,g as Te,d as ye}from"./firebase-auth-nYrUksUt.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function V(e,t,n){let s=t;return n==null&&(s=`https://${t}`),`${n}://${s}/v0${e}`}function ee(e){const t=encodeURIComponent;let n="?";for(const s in e)if(e.hasOwnProperty(s)){const r=t(s)+"="+t(e[s]);n=n+r+"&"}return n=n.slice(0,-1),n}var A;(function(e){e[e.NO_ERROR=0]="NO_ERROR",e[e.NETWORK_ERROR=1]="NETWORK_ERROR",e[e.ABORT=2]="ABORT"})(A||(A={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function et(e){if(typeof atob>"u")throw Be("base-64");return atob(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(t,n){this._service=t,n instanceof _?this._location=n:this._location=_.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new U(t,n)}get root(){const t=new _(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return oe(this._location.path)}get storage(){return this._service}get parent(){const t=it(this._location.path);if(t===null)return null;const n=new _(this._location.bucket,t);return new U(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Fe(t)}}function kt(e,t,n){e._throwIfRoot("uploadBytes");const s=wt(e.storage,e._location,ie(),new k(t,!0),n);return e.storage.makeRequestWithTokens(s,he).then(r=>({metadata:r,ref:e}))}function Et(e){e._throwIfRoot("getDownloadURL");const t=mt(e.storage,e._location,ie());return e.storage.makeRequestWithTokens(t,he).then(n=>{if(n===null)throw Se();return n})}function At(e,t){const n=at(e._location.path,t),s=new _(e._location.bucket,n);return new U(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="storage";function Lt(e,t,n){return e=L(e),kt(e,t,n)}function vt(e){return e=L(e),Et(e)}function St(e,t){return e=L(e),It(e,t)}function Bt(e=Te(),t){e=L(e);const s=be(e,fe).getImmediate({identifier:t}),r=we("storage");return r&&Pt(s,...r),s}function Pt(e,t,n,s={}){Nt(e,t,n,s)}function Ct(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,me)}function Dt(){_e(new ge(fe,Ct,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2017")}Dt();export{vt as a,Bt as g,St as r,Lt as u};
